...
namespace Rejoin.Migrations
{
    ...
    [Migration("20200111081649_LookJobsPSkillsLanguagesTableCreated")]
    partial class LookJobsPSkillsLanguagesTableCreated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rejoin.Models.PSkill", b =>
                {
                    b.Property<int>("PSkillId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Rejoin.Models.Profession", b =>
                {
            ...
            modelBuilder.Entity("Rejoin.Models.Profession", b =>
                {
                    b.HasOne("Rejoin.Models.User", "user")
                        .WithOne("Profession")
                        .HasForeignKey("Rejoin.Models.Profession", "UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
